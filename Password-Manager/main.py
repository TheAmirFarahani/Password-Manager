...
def return_user_service_password(variable_to_retrive:str):
    """
    Returns a varible based on the string, if the string is none returns all of user_id, service_id, password_id
    """
    while run:
        ...
        if user_index in user_id_map:
            ...
            valid_user_id = True 
            if variable_to_retrive == "user_id":
                return user_id 
        else:        
            print("\nID is invalid")
            continue
        while valid_user_id: 
            ...
            if service_index in service_id_map:
                ...
                if variable_to_retrive=="service_id":
            ...
            while valid_service_id:
                ...
                if password_index in password_id_map:
                    ...
                    return user_id, service_id, password_id
                else:        
                    print("\nID is invalid")
                    continue
return_user_service_password("password")